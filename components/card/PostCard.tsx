        ...
        <div className="flex gap-x-4 items-center">
          ...
          <div className="flex flex-col gap-y-2">
            <div className="flex items-center gap-x-2">
              ...
              <Tooltip content={new Date(post.createdAt).toLocaleString()}>
              ...
              {post.approved && !isUserPage && (
                <Tooltip
                  content={"Moderadores deste grupo aprovaram este post."}
                >
            ...
            <Link href={`/group/${post.group.groupname}`}>
              <Chip className="bg-background border-default p-0 px-0" startContent={<Image removeWrapper={true} src={post.group.image + '?size=50'} className='w-6 h-6'/>}>
